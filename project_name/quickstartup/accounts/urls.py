...
INCLUDE_REGISTER = getattr(settings, 'INCLUDE_REGISTER_URL', True)
INCLUDE_AUTH_URLS = getattr(settings, 'INCLUDE_AUTH_URLS', True)
...
# There is accounts to be managed
if INCLUDE_AUTH_URLS or INCLUDE_REGISTER:
    urlpatterns += patterns(
        '',  # prefix
        ...
        url(r'^activate/complete/$',
            view=TemplateView.as_view(
                template_name='accounts/activation-complete.html',
            ),
