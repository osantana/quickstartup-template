...
urlpatterns = patterns('',
    ...
    url(r'^password/reset/$', "quickstartup.account.views.password_reset", name="password-reset"),
    ...
    url(r'^password/reset/(?P<uidb64>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        ...
        {"template_name": "account/reset-confirm.html", "set_password_form": CustomSetPasswordForm},
